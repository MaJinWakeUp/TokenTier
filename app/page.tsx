...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer><a className="brand" href={activeView === "explore" ? "#explore-top" : "#recommendation-top"}><span className="brand-mark">T/T</span><span>TokenTier</span></a><span>Prices in USD</span></footer>
    </main>
  );
}
